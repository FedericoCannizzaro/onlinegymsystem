...
<html>
	<head>
		...
		<title><?php echo("Pannello istruttore: ".$us[name]." ".$us[surname]."") ?></title>
	</head>
	<body>
	<?php include'top.php'; ?>
    	<div id="corpo">
					...
					if(!($status == AUTH_LOGGED && $user[type]=='1')){
                    	...
                    	echo(" 
                        	<div id='function_bar'>
                        		...
                        		<div id='function_button'><a href='show_users.php?mode=client' id='function_text'>Lista allievi</a></div>
